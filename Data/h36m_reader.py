...
import random
import pickle
from Utils.Utils import split_clips
random.seed(0)


class DataReaderH36M:
    def __init__(self, n_frames, sample_stride, data_stride_train, data_stride_test,
                 dt_root='data/motion3d', dt_file='h36m_cpn_cam_source.pkl', read_confidence=True):
        ...
        # Load dataset
        with open(f'{dt_root}/{dt_file}', 'rb') as file:
            self.dt_dataset = pickle.load(file)
